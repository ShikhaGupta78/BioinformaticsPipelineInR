...
# BWA command to map the generated FastQ file to the reference genome and index SAI file generated as output
bwa aln -t 8 /media/lpmb3/iGenomes/Mus_musculus/UCSC/mm10/Sequence/BWAIndex/genome.fa /media/lpmb3/Shikha/SRA/$1.fastq > $1.sai

# BWA command to finally generate the SAM file out of the index SAI and FastQ files
...
# Generate index out of sorted BAM file from which duplicates were removed
