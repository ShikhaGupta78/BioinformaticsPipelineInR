...
# Creating a new data frame to store accessible chromosome coordinates, and ATAC and ChIP-seq peak heights 
...
# Following steps were to normalize the total number of reads in the two columns "ATAC-seq peaks with Ascl1 induction" and "ATAC-seq peaks without Ascl1 induction"
